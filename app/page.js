    ...
    about: {
      ...
      values: [
        ...
        { title: "Portal colaborativo", desc: "Workflow para times clínicos, compras e finanças aprovarem cada lote com rastreabilidade completa." },
        {
          ...
          desc: "Negociações para cobrir propostas concorrentes e garantir as melhores condições comerciais.",
        },
      ],
      statsTitle: "Governança & capilaridade",
      stats: [
        { value: "6+", label: "fábricas auditadas em 2023/24" },
        { value: "REDE DE PARCEIROS", label: "🇨🇳 • 🇰🇷" },
    ...
    about: {
      ...
      values: [
        ...
        { title: "Collaborative portal", desc: "Workflow for clinical, sourcing and finance teams to approve each lot with full traceability." },
        {
          ...
          desc: "Negotiations to beat competing bids and secure superior commercial terms.",
        },
      ],
      statsTitle: "Governance & reach",
      stats: [
        { value: "6+", label: "factory audits completed in 2023/24" },
        { value: "PARTNER NETWORK", label: "🇨🇳 • 🇰🇷" },
    ...
    about: {
      ...
      values: [
        ...
        { title: "Portal colaborativo", desc: "Workflow para clínicas, compras y finanzas aprobando cada lote con trazabilidad completa." },
        {
          ...
          desc: "Negociamos para superar ofertas de competidores y asegurar mejores condiciones comerciales.",
        },
      ],
      statsTitle: "Gobernanza & alcance",
      stats: [
        { value: "6+", label: "fábricas auditadas en 2023/24" },
        { value: "RED DE SOCIOS", label: "🇨🇳 • 🇰🇷" },
  ...
  ar: {
    ...
    about: {
      ...
      values: [
        ...
        {
          title: "تنافسية الأسعار",
          desc: "نتفاوض لتجاوز عروض المنافسين وتأمين أفضل الشروط التجارية.",
        },
      ],
      statsTitle: "الحوكمة والانتشار",
      stats: [
        { value: "6+", label: "تدقيق مصانع منجز في 2023/24" },
        { value: "شبكة الشركاء", label: "🇨🇳 • 🇰🇷" },
  ...
  ko: {
    ...
    about: {
      ...
      values: [
        ...
        {
          title: "가격 경쟁력",
          desc: "경쟁사 제안을 상쇄하고 더 나은 조건을 확보하기 위한 협상.",
        },
      ],
      statsTitle: "거버넌스 & 커버리지",
      stats: [
        { value: "6+", label: "2023/24년에 완료한 공장 감사" },
        { value: "파트너 네트워크", label: "🇨🇳 • 🇰🇷" },
...
<section id="solutions" className="relative py-16 md:py-24">
  <div
    className="absolute inset-0 -z-10 bg-gradient-to-b from-transparent via-white/60 to-transparent"
    aria-hidden="true"
  />
  <div className="mx-auto max-w-6xl px-4">
